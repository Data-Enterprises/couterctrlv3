...
export const salesLegacySlice = createSlice({
  name: "legacySalesLegacy",
  initialState,
  reducers: {
    ...
    resetSalesLegacySlice: () => initialState,
  },
});
...
export const {
  ...
  setNoTrackerFound,
} = salesLegacySlice.actions;
export default salesLegacySlice.reducer;
