...
const TotalsGridLvlTwoTablet = ({
  ...
  return (
    <div className="">
      <div
        className="grid grid-cols-6 gap-2 rounded-xl px-3 py-2 text-[12px] md:text-[12.5px] font-medium items-center cursor-pointer bg-custom-white hover:bg-blue-50 transition-colors duration-200"
        onClick={chevronTurn}
      >
