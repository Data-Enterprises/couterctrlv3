/**
 * Dev copy of `features/baseGroupSlice.ts`, mounted at `state.dev.baseGroup` and read only
...
export const baseGroupSlice = createSlice({
  // Distinct from the prod slice's "baseGroup": Redux matches actions on this
