/**
 * Dev copy of `features/forecastSlice.ts`, mounted at `state.dev.forecast` and read only
...
export const forecastSlice = createSlice({
  // Distinct from the prod slice's "forecast": Redux matches actions on this
