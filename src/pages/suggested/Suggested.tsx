...
import DevSuggested from "./dev/Suggested";

/**
 * Suggested is a Coming Soon page: dev only.
 *
 * It has a `pages/suggested/dev` tree and no prod tree until it is greenlit. The
