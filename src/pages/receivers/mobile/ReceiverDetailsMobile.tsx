    ...
    <div className="min-h-[calc(100vh-3rem)] text-[12px] max-h-[calc(100vh-3rem)] overflow-y-auto">
      <div className="grid grid-cols-2">
        ...
        >
          ...
          <div className="text-content/85">Received</div>
        </div>
      </div>
          ...
          <div className="bg-custom-white rounded-lg shadow-md px-2 pt-1 pb-1.5">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-slate-100 py-1 px-2 rounded-md shadow-md flex justify-between">
                <div className="text-content/85">Cases:</div>
                <div className="font-medium">
                  {formatBigNumber(totals.cases, 0)}
                </div>
              </div>
              <div className="bg-slate-100 py-1 px-2 rounded-md shadow-md flex justify-between">
                <div className="text-content/85">Units:</div>
                <div className="font-medium">
              ...
              <div className="bg-slate-100 py-1 px-2 rounded-md shadow-md flex justify-between">
                <div className="text-content/85">E Cost:</div>
                <div className="font-medium">
                  {formatCurrency2(totals.ext_cost)}
                </div>
              </div>
              <div className="bg-slate-100 py-1 px-2 rounded-md shadow-md flex justify-between">
                <div className="text-content/85">Retail:</div>
                <div className="font-medium">
                  {formatCurrency2(totals.retail)}
                </div>
              </div>
              <div className="bg-slate-100 py-1 px-2 rounded-md shadow-md flex justify-between">
                <div className="text-content/85">E Retail:</div>
                <div className="font-medium">
            ...
            {details.map((d, i) => (
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  ...
                  <div className="flex justify-between bg-custom-white rounded-md shadow py-1 px-2">
                    <div className="text-content/85">GM:</div>
                    <div className="">{formatBigNumber(d.gm, 2)}</div>
                  </div>
                  <div className="flex justify-between bg-custom-white rounded-md shadow py-1 px-2">
                    <div className="text-content/85">Free:</div>
                    <div className="">{formatBigNumber(d.free, 0)}</div>
                  </div>
                  <div className="flex justify-between bg-custom-white rounded-md shadow py-1 px-2">
                    <div className="text-content/85">Return:</div>
