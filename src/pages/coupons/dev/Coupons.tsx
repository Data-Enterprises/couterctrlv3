...
import {
  ...
  setNoCouponsFound,
  setCoupons,
} from "../../../features/dev/devCouponSlice";
...
const Coupons = () => {
  ...
  // This page only ever rendered with devMode on, so phones already got the
  // newer mobile view (was devMobile/CouponsMobileDev); the old one is gone.
