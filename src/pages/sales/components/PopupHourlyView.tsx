            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div
                    className={`text-[12px] font-medium ${isSel ? "text-white" : "text-content"}`}
                  >
                    {ampm(r.hour)}
                  </div>
                  <div
                    className={`text-[9px] ${isSel ? "text-white/40" : "text-content/40"}`}
                  >
        ...
        {selected ? (
          <>
            ...
            <div className="px-4 py-1 flex-1 overflow-y-auto thin-scrollbar">
              ...
              {/* Transactions */}
              <div className="flex items-center justify-between py-2.5 border-b border-gray-100">
                <span className="text-[12px] text-content/80">Transactions</span>
                <div className="flex flex-col items-end gap-0.5">
              ...
              {/* Avg basket */}
              <div className="flex items-center justify-between py-2.5 border-b border-gray-100">
                <span className="text-[12px] text-content/80">Avg basket</span>
                <div className="flex flex-col items-end gap-0.5">
                  <span className="text-[12px] font-medium text-content">
              ...
              {lwAvgBasket > 0 && (
                <div className="flex items-center justify-between py-2.5 border-b border-gray-100">
                  <span className="text-[12px] text-content/80">Avg basket vs LW</span>
                  <span
