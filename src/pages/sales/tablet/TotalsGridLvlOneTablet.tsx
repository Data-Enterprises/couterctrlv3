...
return (
  <div className="">
    <div
      className="grid grid-cols-6 gap-2 rounded-xl px-3 py-2 font-semibold text-[12px] md:text-[13px] items-center cursor-pointer bg-white hover:bg-blue-50 transition-colors duration-200"
      onClick={chevronTurn}
    >
    ...
    >
      {filtered.map((week, widx) => {
        ...
        return (
          <TotalsGridLvlTwoTablet key={widx} week={week} weekTotals={weekTotals} />
        );
      })}
    </div>
