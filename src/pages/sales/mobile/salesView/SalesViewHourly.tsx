...
const SalesViewHourly = ({ displayName }: SalesViewHourlyProps) => {
  ...
  const lyDate = ctx.salesViewHourlyLastYear[0].sale_date;
              ...
              return (
                <div key={i} className="grid grid-cols-2 gap-2 px-2">
                  ...
                  {tyData ? (
                    ...
                    <div className="rounded-lg shadow-md p-1.5 flex justify-center items-center font-medium text-content/60 bg-bkg">
                      No Data
                    </div>
                  )}
                  {/* Last year */}
