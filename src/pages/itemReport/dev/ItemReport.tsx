...
import type { ItemReportHandoff } from "../../../features/dev/devItemReportSlice";
import { collectCriticalItems } from "../../../utils/itemGrading";
...
const ItemReport = () => {
  ...
  const state = useAppSelector((s) => s.dev.itemReport);
