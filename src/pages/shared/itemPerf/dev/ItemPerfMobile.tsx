...
import ScannerView from "../../../../components-dev/scanner/ScannerView";
...
import {
  ...
  ROWS_PER_PAGE,
  sourceOf,
} from "../../../../features/dev/devItemPerfSlice";
import {
  buildDailyRows,
  buildGroupRows,
  buildItemRows,
...
import { LY_COLOR, TY_COLOR } from "../../../../components-dev/mobile/perf/perfColors";
...
const ItemPerfMobile = ({ dimension, title, listLabel }: Props) => {
  ...
  const perf = useAppSelector((s) => s.dev.itemPerf);
