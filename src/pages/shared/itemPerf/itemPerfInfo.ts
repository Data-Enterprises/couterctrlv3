...
export const itemPerfMobileInfo = (
  ...
  return {
    ...
    glossary: [
      ...
      { term: "Bars", desc: `Sales this year (TY) against last year (LY) — on the top card, the day chart and every ${n.one} and item in the list. The percentage says how healthy; the bars say how much was sold.` },
      { term: "Gross profit / Cost", desc: "Sales before tax minus the cost of goods sold, and that cost — this year on the top row, last year beneath. Cost is what was actually paid after vendor allowances, and weighted items cost by the pound." },
      ...
      { term: "Sort by", desc: "Sales puts the biggest sellers first. Profit puts the biggest earners first. GPM puts the thinnest margins first. Change vs LY puts the biggest drop in sales first; anything with no sales last year goes to the bottom. Name sorts A to Z." },
