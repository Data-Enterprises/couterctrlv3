...
import { setAvailableEmailDetails, setRefresh, setUserInfo } from "../../../../../features/usersSlice";
...
const BasicInfoTab = () => {
  ...
  const handleEmailValidation = () => {
    ...
    if (existing && existing.id === ctx.selectedUserId) {
      ctx.dispatch(setAvailableEmailDetails({ availableEmailText: "- No change", emailTextColor: "text-content" }));
      return;
    }
