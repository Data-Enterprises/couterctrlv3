...
const DeleteBGForm = () => {
  ...
  return (
    <div data-testid="bg-delete-step-1-container">
      <div className="bg-custom-white p-2 w-[75%] rounded-lg shadow-lg">
        {/* Companies */}
        ...
        {baseGroups.length ? (
          <div className="text-[13px] my-3">
            ...
            <div
              ...
              className={`grid grid-cols-2 select-none rounded-lg p-1 max-h-[55vh] overflow-y-auto`}
            >
              {baseGroups.map((bg, i) => (
                <div
                  key={bg.id}
          ...
          <div className="space-y-2">
            ...
            <div>
              <button
                ...
                className={`btn-themeOrange bg-red-600 border-red-600 w-full py-1.5 text-[13px] ${!selectedBgID && "opacity-50 pointer-events-none"}`}
