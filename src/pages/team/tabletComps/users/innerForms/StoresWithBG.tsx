...
const StoresWithBG = () => {
  ...
  return (
    <div className="space-y-2 select-none">
      <div className="flex flex-wrap gap-2 max-h-[50px] overflow-y-auto leading-tight">
      ...
      <div className="max-h-[450px] pb-2 overflow-y-auto grid grid-cols-3 gap-2 text-[11.5px]">
