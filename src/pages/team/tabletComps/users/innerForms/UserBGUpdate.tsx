...
const UserBGUpdate = () => {
  ...
  return (
    <div className="bg-custom-white p-3 rounded-xl shadow-lg">
      <div className="leading-tight mb-2">
        <div className="font-medium">Base Groups</div>
        <div className="text-content/60 text-[12px]">
          Select one or more base groups to assign/unassign to this user
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-1.5 text-[12px] leading-tight mb-1">
      ...
      {userCompany !== null ? (
        <div className="grid grid-cols-2 gap-2">
          <div className="relative">
            ...
            <div className="space-y-1.5 pb-2 max-h-[23.5vh] overflow-y-auto no-scrollbar text-[11.5px] leading-tight">
