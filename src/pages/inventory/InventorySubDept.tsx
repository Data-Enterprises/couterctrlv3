...
import DevInventorySubDept from "./dev/InventorySubDept";

/**
 * InventorySubDept is a Coming Soon page: dev only.
 *
 * It has a `pages/inventory/dev` tree and no prod tree until it is greenlit. The
