...
const CpnSalesDetailPanel = ({
  ...
  const txLines: TransactionListItem[] = useAppSelector((s) => s.prod.couponSales.receiptLines);
  ...
  const breakdown = useAppSelector((s) => s.prod.couponSales.breakdown);
  ...
  const selectedSectionKey = useAppSelector((s) => s.prod.couponSales.selectedSectionKey);
  const selectedStoreKey = useAppSelector((s) => s.prod.couponSales.selectedStoreKey);
  const sectionFilter = useAppSelector((s) => s.prod.couponSales.sectionFilter);
