...
import DevSalesTracker from "./dev/SalesTracker";

/**
 * SalesTracker is a Coming Soon page: dev only.
 *
 * It has a `pages/salesTracker/dev` tree and no prod tree until it is greenlit. The
