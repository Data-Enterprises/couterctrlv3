    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-[#1e2a4a] px-4 py-2.5 flex-shrink-0">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="w-[22px] h-[22px] flex items-center justify-center rounded border border-white/20 text-white/60 hover:text-white hover:border-white/40 transition-colors"
          >
      ...
      <div className="flex-1 overflow-y-auto thin-scrollbar">
        ...
        {visibleCards.map((card) => (
          <div key={card.order_type}>
            {activeType === "all" && (
              <div className="px-4 py-1.5 bg-[#1e2a4a]/5 border-b border-gray-100">
            ...
            {card.dates.map((dateGroup) => (
              <div key={dateGroup.order_date}>
                <div className="px-4 py-1.5 bg-gray-50 border-b border-gray-100">
                  <span className="text-[10px] font-medium text-content/75">{fmtDate(dateGroup.order_date)}</span>
                </div>
                  ...
                  {dateGroup.stores.map((store) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {store.frequency > 1 && (
                          <span className="text-[10px] text-content/75 bg-gray-100 rounded-full px-2 py-0.5">
