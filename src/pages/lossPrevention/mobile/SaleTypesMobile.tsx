...
const SaleTypesMobile = () => {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-4 text-[10.5px] gap-2 p-2">
        {cashier.saleTypes.map((st, i) => (
          <div
            ...
            )} py-1 px-2 rounded-full text-center shadow-md shadow-content/20 transition-all duration-200`}
...
export default SaleTypesMobile;
