      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="grid grid-cols-3 mb-1.5">
          ...
          <div className="px-1.5 py-1">
            ...
            {grade.lwSales > 0 && (
              <div className={`text-[9px] font-medium mt-0.5 ${grade.lwPtsDelta >= 0 ? "text-emerald-600" : "text-red-500"}`}>
          ...
          <div className="px-1.5 py-1">
            ...
            {grade.lySales > 0 && (
              <div className={`text-[9px] font-medium mt-0.5 ${grade.ptsDelta >= 0 ? "text-emerald-600" : "text-red-500"}`}>
