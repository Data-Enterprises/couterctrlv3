...
import SubDeptsTablet from "./SubDeptsTablet";
import WeeklyTrendsTablet from "./WeeklyTrendsTablet";

const SubMarginControlsTablet = () => {
...
export default SubMarginControlsTablet;
